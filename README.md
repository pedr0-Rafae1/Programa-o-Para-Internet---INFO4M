...
Logout.php: Arquivo que tem como funcionalidade fazer com que o usuário saia da pagina principal e volte para a pagina de login.

Painel.php: Arquivo referente a pagina principal quando o login funciona e o usuário acessa sua conta no site.

protect.php: Arquivo que serve para impedir que o usuário acesse a pagina principal sem ter feito o login ainda.
